...
class MessageTest extends TestCase
{
    ...
    public function test_client_can_send_message_in_own_conversation(): void
    {
        Notification::fake();
    ...
    public function test_worker_can_send_message_in_own_conversation(): void
    {
        Notification::fake();
    ...
    public function test_client_cannot_send_message_to_others_conversation(): void
    {
    ...
    public function test_worker_cannot_send_message_to_unassigned_conversation(): void
    {
    ...
    public function test_poll_returns_messages_after_id(): void
    {
        ...
        $response = $this->actingAs($this->client)
            ->getJson("/client/messages/poll/{$this->conversation->id}?after={$msg1->id}");
    ...
    public function test_mark_as_read_updates_read_at(): void
    {
        ...
        $response = $this->actingAs($this->worker)
            ->postJson("/worker/messages/{$this->conversation->id}/read");
    ...
    {
        $response = $this->getJson("/client/messages/poll/{$this->conversation->id}");

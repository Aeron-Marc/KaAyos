...
export const bookings = [
  {
    ...
    rawStatus: 'accepted',
    price: 450,
    location: '123 Purok 1, Barangay Sta. Cruz, Tuy, Batangas',
    notes: 'Please bring extra pipe fittings.',
  },
  {
    id: 2,
    workerId: 3,
    workerName: 'Elena Santos',
    service: 'Deep Cleaning',
    date: 'Oct 20, 2026 - 1:00 PM',
    rawStatus: 'completed',
    price: 1200,
    location: '456 Purok 3, Barangay Sta. Cruz, Tuy, Batangas',
    notes: null,
  },
  {
    id: 3,
    ...
    date: 'Oct 28, 2026 - 9:00 AM',
    rawStatus: 'new',
    price: 600,
    location: '789 Purok 5, Barangay Kayreyna, Tuy, Batangas',
    notes: 'Check all outlets in the house.',
  },
  {
    id: 4,
    workerId: 2,
  ...
  },
  {
    id: 5,
    workerId: 5,
    workerName: 'Rosa Mendoza',
    service: 'Garden Landscaping',
    date: 'Oct 30, 2026 - 7:00 AM',
    rawStatus: 'cancelled',
    price: 2500,
    location: '321 Purok 7, Barangay Kayreyna, Tuy, Batangas',
    notes: null,
  },
];

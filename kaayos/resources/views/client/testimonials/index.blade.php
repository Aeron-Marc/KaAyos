...
<div class="testimonials-header">
    ...
    <a href="{{ route('client.testimonials.create') }}" class="btn-new-testimonial">
...
@else
    <div class="empty-state" style="text-align:center;padding:60px 20px;">
        ...
        <a href="{{ route('client.testimonials.create') }}" style="display:inline-flex;align-items:center;gap:8px;padding:10px 20px;border-radius:8px;background:var(--b6);color:#fff;text-decoration:none;font-size:.9rem;font-weight:600;transition:all .18s;">

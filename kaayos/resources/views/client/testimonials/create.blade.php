...
<div class="testimonial-form-card">
    ...
    <form method="POST" action="{{ route('client.testimonials.store') }}" id="testimonialForm">
        @csrf
        ...
        <div class="form-group">
            ...
            <textarea
                ...
                rows="5"
                maxlength="1000"
                placeholder="What did you like about KaAyos? How has it helped you as a homeowner?"
                required
            ...
            <div class="testimonial-preview-card">
                ...
                <div class="author">
                    ...
                    <div class="author-info">
                        ...
                        <div class="role">Homeowner, {{ auth()->user()->barangay ?? 'Tuy' }}</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="form-actions">
            <a href="{{ route('client.testimonials.index') }}" class="btn-cancel">My Testimonials</a>
